...
class Order(models.Model):
    ...
    # user profile imported from profile app
    # on_delete set to Null to ensure if the profile is deleted
    # the order history still remains
    ...
    def _generate_order_number(self):
        """
        Generate a random string with 32 char,
